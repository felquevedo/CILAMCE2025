...
In general, the lining pressures remain close to the reference value $p(\theta=90^\circ)$, except in the range $0^{\circ} < \theta < 60^{\circ}$, where a significantly increase is observed, reaching about twice the crown pressure in S1 at $\theta = 0^{\circ}$ with higher anisotropy value at the end of construction with viscoelastic lining about twice and a half, (see \cref{Fig6}(b)). There is also a slight increase in anisotropy from $\theta = 120^{\circ}$ to $180^{\circ}$, reach up to 25\%. Therefore, stress concentrations tend to be higher at the lateral sides of the tunnels ($\theta = 0^{\circ} \ \text{and} \ 180^{\circ}$).
